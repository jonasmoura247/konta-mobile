...
class _IncomesListSheetState extends State<IncomesListSheet> {
  List<Income> get _monthIncomes => widget.incomes
      .where((i) => i.recurring || isSameMonth(i.date, widget.activeMonth))
      .toList()
  ...
  void _openNew() {
    ...
    final lastDay = DateTime(
      widget.activeMonth.year,
      widget.activeMonth.month + 1,
      0,
    ).day;
    final initialDate = DateTime(
      widget.activeMonth.year,
      widget.activeMonth.month,
        ...
        child: Column(
          children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(capitalize(formatMonth(widget.activeMonth)),
                              style: TextStyle(
            ...
            Expanded(
              child: items.isEmpty
                  ? Center(
                      child: Text('Nenhuma entrada neste mês',
                  ...
                  : ListView.separated(
                      ...
                      separatorBuilder: (_, __) =>
                          Divider(height: 1, color: context.kCardBorder),
                      itemBuilder: (ctx, i) {
                        final inc = items[i];
                        return ListTile(
