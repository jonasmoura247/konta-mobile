...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  void _load() {
    ...
    // Exibe os 12 meses do ano corrente (jan–dez)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text('Visão geral $year', style: TextStyle(color: context.kTextPrimary, fontSize: 16, fontWeight: FontWeight.bold)),
          ...
          Container(
            ...
            child: BarChart6Months(months: _months, expenses: _expenses, incomes: _incomes, debits: _debits, currency: currency),
          ),
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Row(
                        children: [
                          Text(capitalize(formatMonth(_months[i])), style: TextStyle(color: context.kTextPrimary, fontWeight: FontWeight.w600)),
